...
import { inscribeRecipePage } from "../services/cookbook/RecipePageService.js";
...
import { buildCookPhaseContext, buildCookSuccessContext } from "../engine/cooking/CookPhaseModel.js";
import { emitCookCompleted } from "../services/cooking/CookSignal.js";
...
export class LivingCookbookApp extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    _buffLines(recipe) {
        return MealBuffHandlers.cardSummaries(recipe.partyEffect ?? {}, false);
    }
