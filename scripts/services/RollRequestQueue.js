...
/**
 * Shared single-active queue for every roll-request this module raises through
 * the library bridge. Cooking and serving both prompt the same target client,
 * so funnelling them here guarantees a player only ever sees one prompt at a
 * time instead of overlapping overlays.
 */
