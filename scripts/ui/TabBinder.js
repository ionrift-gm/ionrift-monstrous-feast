...
/**
 * Header flyout panels (Help, Manage). A toggle button opens its matching panel
 * as an anchored overlay; clicking the toggle again, a close control, or outside
 * the panel dismisses it. Delegated on the persistent root element so it survives
 * part re-renders.
 * @param {HTMLElement} root
 */
