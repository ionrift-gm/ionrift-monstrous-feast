...
const REGISTRY_PATH = `modules/${MODULE_ID}/scripts/data/catalogs/creature-registry.json`;
const HOMEBREW_PATH = `modules/${MODULE_ID}/data/homebrew/creatures.json`;
...
/**
 * Creature-to-yield registry keyed by classifyCreature() ids.
 * Precedence: bundled < overlay < homebrew.
 */
