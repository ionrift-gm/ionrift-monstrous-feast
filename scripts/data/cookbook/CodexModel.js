import { CreatureRegistry } from "../catalogs/CreatureRegistry.js";
import { RecipeRegistry } from "../catalogs/RecipeRegistry.js";
import { CookEngine } from "../../engine/cooking/CookEngine.js";
import { countIngredient, findAvailable } from "../../services/cooking/IngredientMatcher.js";
...
import { MealBuffHandlers } from "../../services/meals/MealBuffHandlers.js";
...
export const CODEX_SECTION_DEFS = [
    {
        ...
        subtitle: "Monster Meat meals and pantry staples."
    },
    {
        id: "creatures",
        kind: "creatures",
        title: "Creature cuts",
        subtitle: "Named creatures and their dishes."
    }
];
...
export const RECIPE_LIST_SECTION_DEFS = [
    {
        id: "methods",
        title: "Cooking methods",
        subtitle: "Monster Meat meals and pantry staples. Butcher to unlock."
    },
    {
        id: "signatures",
        title: "Signature dishes",
        subtitle: "Named dishes. Butcher the creature first."
    }
];
...
/**
 * Structured buff groups for recipe cards (duration parent, effect children).
 * Display only. Driven by the registered buff handlers, so an overlay buff
 * surfaces on the card without a code change here; unknown keys are logged once
 * and skipped.
 * @param {object} recipe
 * @returns {{ duration: string|null, effects: { label: string, detail: string|null }[] }[]}
 */
function buffSummary(recipe) {
    return MealBuffHandlers.cardSummaries(recipe.partyEffect ?? {});
}
...
function recipeLockReason(recipe, labelMap) {
    ...
    return "Butcher a matching creature to unlock";
}
...
function mapRecipe(recipe, actor, inscribed, {
    ...
    return {
        ...
        cookTooltip: !inscribed
            ...
            : (!discoveryUnlocked
                ? (lockReason ?? "Butcher a matching creature first")
