 ...
 * game.ionrift.library.system (the kernel adapter registry) and handles
 * survival checks, challenge rating, and item shapes locally per system.
 */
export const SystemBridge = {
    ...
    /** @returns {import("../../ionrift-library/scripts/services/IonriftSystemAdapter.js").IonriftSystemAdapter|null} */
    adapter() {
